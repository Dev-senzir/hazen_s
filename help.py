commands = '''
@ppqnu - تــشــيــكــر حزين**
هـذه هـي أوامــر تـشـيـكر حزين @ppqnu
...
"""
sec4 = """
الاوامر الاضافية | سورس حزين @ppqnu
...
مثال | [`.مؤقت 3 5 مرحبأ بك في سـورس حزين` ]
...
مثال | `.للخاص مرحبًا بك في سـورس حزين `
