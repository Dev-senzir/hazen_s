...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك سيد ابشر  @ppqnu')
...
async def _(event):
        ...
        await asyncio.sleep(5)
        msg1 = await Tepthon.get_messages('@EEObot', limit=1)
...
async def _(event):
      await event.reply("""السـورس يعمـل حزين يعمل بنجاح @ppqnu
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
